...
<figure style="margin: 1.5rem 0;">
  <img src="../images/feature-custom-dashboard.gif" alt="Custom Dashboard — create widgets, resize them, and monitor your process in real time" style="width: 100%; border-radius: 8px; box-shadow: 0 2px 12px rgba(0,0,0,0.15);" loading="lazy">
