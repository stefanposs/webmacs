...
| Variable | Default | Description |
|---|---|---|
| `INITIAL_ADMIN_EMAIL` | `admin@webmacs.local` | Email for the auto-seeded admin |
| `INITIAL_ADMIN_USERNAME` | `admin` | Username |
| `INITIAL_ADMIN_PASSWORD` | `admin123` | Password — **auto-generated by install script in production** |
...
| `ADMIN_EMAIL` | `admin@webmacs.local` | Passed to backend + controller |
| `ADMIN_USERNAME` | `admin` | Admin username |
| `ADMIN_PASSWORD` | `admin123` | Admin password — **auto-generated by install script** |
